...
export const useFetchDocuments = (docColletcion, search = null, uid = null) => {
    ...
    useEffect(() => {
        async function loadData() {
            ...
            const collectionRef = await collection(db, docColletcion);
        ...
        loadData();
    }, [docColletcion, search, uid, cancelled]);
